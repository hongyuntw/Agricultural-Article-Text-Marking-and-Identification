...
batch_size = 24
score_used_epoch = 2
score_model_path = f'./outputs_models/colbert_hard_neg2_rand_neg10/model_{score_used_epoch}.pt'

result_path = f'./output_results/{data_mode}_result_ccolbert_hard_neg2_rand_neg10_epoch{score_used_epoch}'
### hyperparams ###
...
test_set = MyDataset(mode, json_data, tokenizer, add_marker=True)
print(len(test_set))
